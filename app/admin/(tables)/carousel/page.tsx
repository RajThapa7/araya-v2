...
const Page = () => {
  ...
  const mutation = useDeleteCarouselItem();
  ...
  return (
    <div className="flex-flex-col">
      ...
      <p className="text-2xl text-header">Carousel Items</p>
      <div className="flex flex-row mt-6 items-center justify-between">
        ...
        <MyButton
          onClick={() => router.push(`/admin/carousel/add`)}
          className="!py-2"
        >
          Add New
        </MyButton>
                  ...
                  <td className="px-6 py-3">
                    <div className="flex flex-row gap-4 items-center">
                      <FaEye
                        ...
                        onClick={() =>
                          router.push(`/admin/carousel/${item._id}`)
                        }
                      />
                      <FaEdit
                        ...
                        size={18}
                        onClick={() =>
                          router.push(`/admin/carousel/edit/${item._id}`)
                        }
                      />
                      <RiDeleteBin6Line
