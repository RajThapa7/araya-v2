...
function CarouselCard({
  ...
  return (
    <div className="mr-2 md:mr-5">
      <blockquote className="rounded-md flex h-full flex-col justify-between bg-primary p-6 shadow-sm shadow-primary-dark sm:p-8 lg:p-12">
        <div>
          <div className="inline-flex items-center gap-4">
            <Image
              alt="Man"
              src={imageUrl || "/public/user.jpg"}
